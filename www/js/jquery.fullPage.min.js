...
typeof b&&(b=a),K=b,la(g+"/"+b)):("undefined"!==typeof a&&(K=b),la(e)),D(location.hash)):"undefined"!==typeof a?D(f+"-"+a):D(String(f))}function la(a){if(ma)location.hash=a;else if(C||O)history.replaceState(void 0,void 0,"#"+a);else{var b=window.location.href.split("#")[0];window.location.replace(b+"#"+a)}}function D(a){a=a.replace("../index-11.html","-").replace("#","");b("body")[0].className=b("body")[0].className.replace(/\b\s?fp-viewing-[^\s]+\b/g,"");b("body").addClass("fp-viewing-"+a)}function ya(){var a=
